...
@section('content')
        ...
        <div class="row">
            ...
            <form id="myForm">
                    ...
                    <div class="col-md-6">
                        <fieldset class="border px-3 pb-4">
                            ...
                            <div class="form-floating mt+1">
                                <input
                                    style="font-weight: bold; font-size: 32px; vertical-align: middle; display: inline-block; line-height: normal;"
                ...
                <div class="form-floating">
                    <input style="font-weight: bold;" type="text" class="form-control" id="student_id" name="student_id"
                        placeholder="รหัสนักศึกษา" autofocus>
                    ...
                    <table class="table table-bordered">
                        ...
                        @if (count($bookings) > 0)
                            @foreach ($bookings as $key => $booking)
                                <tr>
                                    @php
                                        $carbonDate = Carbon\Carbon::parse($booking->created_at);
                                        $thaiDate = $carbonDate
                                            ->locale('th')
                                            ->tz('Asia/Bangkok')
    ...
    <script>
        function updateRealTime() {
            ...
            const formattedTime = `วัน ${day} ที่ ${date} ${month} ${year} ${hours}:${minutes}:${seconds} น.`;
